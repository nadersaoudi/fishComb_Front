...
import { addEvent, getevents, getcategories, sortEvents } from '../../../Actions/events'
...
const Events = ({ addEvent, getevents, events: { events, categories }, getcategories, sortEvents }) => {
    useEffect(() => {
        getevents()
    }, [getevents])
    useEffect(() => {
                    ...
                    <div className="col-6 pb-3">
                        <ul className="nav nav-pills nav-justified " id='navprofil'>
                            ...
                            <li className="nav-item">
                                ...
                                <button type='submit'>Sort event</button>
                                </form>
...
export default connect(mapStateToProps, { addEvent, getevents, getcategories, sortEvents })(Events);
