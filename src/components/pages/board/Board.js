    ...
    return (
            <div>
                    ...
                    <Col md={4} style={{display:'contents'}}>
                        <ul className="nav">
                            <li className="nav-item">
                                <Link className='nav-link' to={`/dashboard/events`} ><span className="m" style={{ fontFamily: "arial" }}>Latest</span></Link>
                            </li>
                            <li className="nav-item">
                                <Link className='nav-link' to={`/dashboard/invited`} ><span className="m" style={{ fontFamily: "arial" }}>New</span></Link>
                            </li>
                ...
                <Row className='Side_Bar'>
                        ...
                        <form onSubmit >
                            <Col md={12} sm={12} xl={12} className="header__input" >
                                <input type="text" placeholder='Search Fishcomb' aria-label="Search" height='25px' value onChange />
                        ...
                        <Col><button className='btn btn-outline mt-3'>My Account </button></Col>          
