                    ...
                    <div className="card-body">
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <div className="form-group">
                                ...
                                <div className="col-sm-6 mb-3  ">
                                    <input type="text" className="form-control reg__input" placeholder="City"
                                        onChange={e => this.minicity = e.target.value}  />
                                </div> 
                              
                                <div className="col-sm-6 mb-3 ">      
                                    <select id="country" name="country" className="form-control reg__input" onChange={e => this.minicount = e.target.value}>
